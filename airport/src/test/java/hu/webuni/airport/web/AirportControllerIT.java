...
@SpringBootTest(webEnvironment = WebEnvironment.RANDOM_PORT) // starts the webcontainer
public class AirportControllerIT {
	...
	void testThatCreatedAirportIsListed() throws Exception {
		...
		AirportDto newAirport = new AirportDto(5, "hdghdfgélkjdfg", "IGH");
		...
		.usingRecursiveComparison()  //compare fields of object
