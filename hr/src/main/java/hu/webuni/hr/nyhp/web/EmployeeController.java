...
//			throw new ResponseStatusException(HttpStatus.NOT_FOUND);
	...
	@GetMapping("/salary")
	public List<EmployeeDto> getListOfHigherSalary(@RequestParam("salary") int salary, Pageable pageable) {
		return employeeMapper.employeesToDtos(employeeService.findOfHigherSalary(salary,pageable));
	}
